<template>
  <header class="navbar8-container1" v-bind:class="rootClassName">
    <header data-thq="thq-navbar" class="navbar8-navbar-interactive">
      ...
      <div data-thq="thq-navbar-nav" class="navbar8-desktop-menu">
        <nav class="navbar8-links1">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer noopener"
            class="navbar8-link32 thq-body-small thq-link"
          >
            <slot name="link31">
              <!--Default content for link31-->
              <div class="navbar8-fragment17">
                <span class="navbar8-text20">#cashiering</span>
              </div>
            </slot>
          </a>
          <div
            ...
            <a :href="link2Url" class="thq-body-small thq-link">
              <slot name="link2">
                ...
                <div class="navbar8-fragment12">
                  <span class="navbar8-text15">#admin-portal</span>
                </div>
              </slot>
            </a>
            <a :href="link3Url" class="navbar8-link33 thq-body-small thq-link">
              <slot name="link3">
                <!--Default content for link3-->
                <div class="navbar8-fragment13">
                  <span class="navbar8-text16">#cashiering</span>
                </div>
              </slot>
            </a>
                ...
                <span class="thq-body-small thq-link">
                  <slot name="link4">
                    ...
                    <div class="navbar8-fragment20">
                      <span class="navbar8-text23">#qr-scan-ordering</span>
                    </div>
                  </slot>
                </span>
                <div class="navbar8-icon-container2">
                  <div v-if="link5AccordionOpen" class="navbar8-container3">
                    ...
                    <div class="navbar8-content1">
                      ...
                      <span class="thq-body-small">
                        <slot name="page1Description">
                          ...
                          <div>
                            <span>Welcome to our POS System Company</span>
                          </div>
                        </slot>
                      </span>
                    </div>
                    ...
                    <div class="navbar8-content2">
                      ...
                      <span class="thq-body-small">
                        <slot name="page2Description">
                          ...
                          <div>
                            <span>
                              Explore our user-friendly Admin Portal interface
                            </span>
                          </div>
                        </slot>
                      </span>
                    ...
                    <div class="navbar8-content3">
                      ...
                      <span class="thq-body-small">
                        <slot name="page3Description">
                          ...
                          <div>
                            <span>
                              Efficient cashiering experience with our system
                            </span>
                          </div>
                        </slot>
                      </span>
                    ...
                    <div class="navbar8-content4">
                      <span class="navbar8-page41 thq-body-large">
                        <slot name="page4">
                          ...
                          <div><span>QR Scan Ordering</span></div>
                        </slot>
                      </span>
                      <span class="thq-body-small">
                        <slot name="page4Description">
                          ...
                          <div>
                            <span>Seamless QR scan ordering process</span>
                          </div>
                        </slot>
                      </span>
                    </div>
              ...
              <span>
                <slot name="action1">
                  ...
                  <div class="navbar8-fragment23">
                    <span class="navbar8-text26">Main Action</span>
                  </div>
                </slot>
              </span>
            </button>
              ...
              <span>
                <slot name="action2">
                  ...
                  <div class="navbar8-fragment11">
                    <span class="navbar8-text14">Secondary Action</span>
                  </div>
                </slot>
              </span>
            </button>
      ...
      <div v-if="link5DropdownVisible" class="navbar8-container6 thq-box-shadow">
                ...
                <span class="navbar8-page22 thq-body-large">
                  <slot name="page2">
                    ...
                    <div class="navbar8-fragment16">
                      <span class="navbar8-text19">Admin Portal</span>
                    </div>
                  </slot>
                </span>
                <span class="thq-body-small">
                ...
                <span class="navbar8-page32 thq-body-large">
                  <slot name="page3">
                    ...
                    <div class="navbar8-fragment24">
                      <span class="navbar8-text27">Cashiering</span>
                    </div>
                  </slot>
                </span>
                <span class="thq-body-small">
                ...
                <span class="navbar8-page42 thq-body-large">
                  <slot name="page4">
                    ...
                    <div class="navbar8-fragment10">
                      <span class="navbar8-text13">QR Scan Ordering</span>
                    </div>
                  </slot>
                </span>
                <span class="thq-body-small">
                  <slot name="page4Description">
                    ...
                    <div class="navbar8-fragment14">
                      <span class="navbar8-text17">
                        Seamless QR scan ordering process
                      </span>
                    </div>
                  </slot>
                </span>
...
export default {
  ...
  props: {
    ...
    page1ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1564841477299-7b7c8b65b5dc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MjY3ODQ0MXw&ixlib=rb-4.1.0&q=80&w=1080',
    },
    linkUrlPage3: {
      type: String,
      default: 'https://www.teleporthq.io',
    ...
    page4ImageAlt: {
      type: String,
      default: 'Image for QR Scan Ordering Page',
    },
    link1Url: {
      type: String,
      default: 'https://www.teleporthq.io',
    ...
    page2ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1565267172527-5cad7255d962?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MjY3ODQ0NHw&ixlib=rb-4.1.0&q=80&w=1080',
    },
    ...
    page3ImageAlt: {
      type: String,
      default: 'Image for Cashiering Page',
    },
    page3ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1717080637274-835c937eacd8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MjY3ODQ0NHw&ixlib=rb-4.1.0&q=80&w=1080',
    },
    page4ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1618620864043-896c2d11c7fc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc1MjY3ODQ0M3w&ixlib=rb-4.1.0&q=80&w=1080',
    },
    logoAlt: {
      type: String,
      default: 'POS System Company Logo',
    },
    link2Url: {
      type: String,
      default: 'https://www.teleporthq.io',
    ...
    page2ImageAlt: {
      type: String,
      default: 'Image for Admin Portal Page',
    },
    link3Url1: {
      type: String,
      default: 'https://www.teleporthq.io',
